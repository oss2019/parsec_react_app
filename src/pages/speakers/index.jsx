                  ...
                  <div className="col-md-5 py-2">
                    <div className=" border-danger shadow">
                      ...
                      >
                        ...
                        >
                          <strong>Vice President, Engineering & Managing
                                  Director, Trellix</strong>
                        ...
                        <p className="text-dark">
                              ...
                              rich experience of 36 plus years in the industry
                              and is a veteran in the software/ software
                              assisted industry.
                        </p>
                        {/* </div> */}
                      </div>
                  ...
                  <div className="col-md-5 py-2">
                    <div className=" border-danger shadow">
                      ...
                      >
                        ...
                        <h5
                          className="card-title text-danger "
                          style={{ textAlign: "center",fontSize:'1.5rem',color:'#1d1836'}}
                        >
                         Mrs. Bhavi
                        </h5>
                        ...
                        >
                          <strong>
                            Contact : bhavi.daftery@cred.club
                          </strong>
                        </p>
                        <p className="text-dark">
                          Bhavi did her B.Tech. from VJTI, Mumbai. She's been working on interesting problems (and some non-interesting) for the past 8 years.
                          She's a Mumbaikar at heart, Isaac Asimov fan, loves
