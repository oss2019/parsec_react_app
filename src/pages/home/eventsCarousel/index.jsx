						...
						<div class="content-column order-2 col-lg-5 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								>
									...
									who can interweave data structures and algos to solve a
									problem efficiently. Join us at this 3 hour long brainstorming
									coding contest where you can turn yourself into a Code
									Maestro!
								</div>
							</div>
						</div>
						...
						<div class="content-column order-2 col-lg-5 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								>
									...
									<strong>
										jeopardy-style CTF to conquer the flags hidden throughout
										some machines.
									</strong>{' '}
						...
						<div class="content-column order-2 col-lg-5 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								>
									...
									problem and showcase it by creating a 3D model. Join us in
									teams of 2 at this CAD Based product design event!
								</div>
							</div>
						</div>
						...
						<div class="content-column order-2 col-lg-5 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								>
									...
									elements in an economically feasible way by taking part in
									this event.
								</div>
							</div>
						</div>
