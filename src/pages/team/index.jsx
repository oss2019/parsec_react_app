          ...
          <div className="col-12 col-sm-6 col-lg-3" key={`${i}`}>
            <Zoom delay={delayTime}>
              ...
              <div className="single-speaker-area wow fadeInUp ">
                ...
                {(data.facebook !=="" || data.linkedin!=="" || data.instagram!=="" || data.github!=="") && (<div className="social-info">
                  {data.facebook && (
    ...
    <React.Fragment>
      <div className="page-wrapper">
        ...
        <section className="our-speaker-area section-padding-100">
          <div className="auto-container">
            <TeamMembers teamData={coordinatorTeamData} post={"General Secretary Technical Affairs"} title={"Overall Co-ordinator"} />
			<TeamMembers teamData={operationsHead} title={"Operations Head"}/>          
			<TeamMembers teamData={accountsManager} title={"Accounts Manager"}/>
			<TeamMembers teamData={eventManager} title={"Event Manager"} />            
            <TeamMembers teamData={overallJrCoordinator} title={"Jr. Overall Co-ordinator"} />
			<TeamMembers teamData={sponsorshipTeam} title={"Sponsorship Management Team"} />
