        ...
        <section className="project-section">
            ...
            <div className="auto-container">
				...
				<section
					...
					id="page-title"
					style={{
						backgroundImage: `url(images/events/devhack/devhack_banner.png)`,
					}}
				>
					<div className="auto-container">
								...
								<div className="content-column col-lg-8 col-md-12 col-sm-12 tabs-content">
												...
												<div className="login-form">
													<div className="row clearfix">
														<h1
															...
															style={{ color: `#12114a`, textAlign: `center` }}
														>
															About Event
														</h1>
														<div className="form-column col-lg-12 col-md-12 col-sm-12">
															...
															>
																<div className="title-box">
																	...
																	>
																		...
																		researchers have the power to revolutionize
																		the world by transforming their inspiring
																		ideas into solutions that positively impact
																		the society. Prove your worth in this
																		36-hour hackathon by ideating, innovating
																		and hacking meaningful solutions to real
																		life problems.
																	</p>
																</div>
																<div
															...
															<div className="card-body">
																...
																<div className="collapse mt-3" id="t2_details">
																	<p
																		...
																		style={{ fontSize: `medium` }}
																	>
																		Ideas can be real life problems around them
																		that they are keen to solve or can simply be
																		anything they are passionate about and want
																		to see being implemented in this world. The
																		timeline merely serves as a guide to keep
																		track of time and teams who have already
																		decided on the next big change they want to
																		introduce to the world are free to start
																		hacking!
																	</p>
																</div>
															</div>
														...
														<div className="card shadow">
															<div className="card-body">
																...
																>
																	...
																	Whether you're looking for a quick idea or are
																	keen to learn about current trends in
																	technology and see the passion that drives the
																	industry, make sure you don't miss out on our{' '}
														...
														<div className="card border-danger shadow">
															<div className="card-body">
																...
																>
																	...
																	this phase, teams are expected to have started
																	protoyping and developing their idea. As
																	important as an idea can be, transforming it
																	into a solution that impacts the world is all
																	the more essential.
																</p>
															</div>
														</div>
														...
														<div className="card border-danger shadow">
															<div className="card-body">
																...
																>
																	...
																	sure you make every second count as you build
																	upon your hack and go the distance by making
																	it into a minimum viable product.
																</p>
															</div>
														</div>
													</div>
														...
														<div className="card border-danger shadow">
															<div className="card-body">
																...
																<p
																	...
																	style={{ fontSize: `medium` }}
																>
																	<strong> Submit your hack on Devfolio</strong>{' '}
																	and let the world know what you made for them
																	to be eligible to compete for the top
														...
														<div className="card border-danger shadow">
															<div className="card-body">
																...
																<p
																	...
																	style={{ fontSize: `medium` }}
																>
																	<strong> Time to impress the Judges!</strong>{' '}
									...
									<div className="tab" id="theme">
										...
										<div className="content-box">
											<p style={{ fontSize: `large`, color: `#12114a` }}>
												...
												<br></br>
												<br></br>
												Each hack will be judged and ranked separately in their
												respective tracks.
												<br></br>
												<br></br>
												The participants are required to choose from the below
												given themes and pick up a general problem statement and
												solve it based on their domain expertise.
											</p>
											<section
															...
															>
																<div className="speaker-single-thumb">
																	<img
																		...
																		alt=""
																		style={{ height: `185px`, margin: `auto` }}
																	></img>
																</div>
																<div className="speaker-info">
																	<h5 style={{ textAlign: `center` }}>
									...
									<div className="tab" id="hardware">
										...
										<div className="content-box">
											<p style={{ fontSize: `large`, color: `#12114a` }}>
												{' '}
												These are the general ideas to guide you to develop your
												hardware hack. However you can hack on your own idea as
												well.
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															...
															>
																<strong>
																	GDG Hubli Organiser<br></br>Full Stack
																	Engineer at Hashnode
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
															</p>
												...
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Dr. Vasudev Parvati
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium` }}
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Mr. Srikanth Vidapanakal
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium`, color: `#000` }}
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															...
															>
																<strong>
																	Assistant Professor<br></br> Computer Science
																	Department<br></br>
																	IIT Dharwad
																</strong>
																<br></br>
												...
												<div className="col-md-5 py-2">
													...
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Dr. Sudhanshu Shukla
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium` }}
															>
																<strong>
																	Assistant Professor<br></br>Biosciences and
																	Bio engineering Department<br></br> IIT
																	Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
												...
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															...
															>
																<strong>
																	Assistant Professor<br></br>Electrical
																	Engineering Department<br></br> IIT Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
															</p>
												...
												<div className="col-md-5 py-2">
													...
													<div className="card border-danger shadow">
														<div className="card-body">
															...
															>
																<strong>
																	Assistant Professor<br></br>Mathematics
																	Department<br></br> IIT Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
															</p>
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Dr. Ramchandra Phawade
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium`, color: `#000` }}
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Mr. Umesh Gayakwad
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium`, color: `#000` }}
															>
																<strong>
																	Assistant Manager<br></br>Tata Marcopolo
																	Motors
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
												...
												<div className="col-md-5 py-2">
													...
													<div className="card border-danger shadow">
														<div className="card-body">
															...
															>
																<strong>
																	Assistant Professor<br></br>Mechanical
																	Department<br></br>IIT Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Dr. Somashekara M A
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium`, color: `#000` }}
												...
												<div className="col-md-5 py-2">
													...
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Dr. Gopal Sharan Parashari{' '}
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium` }}
															>
																<strong>
																	Assistant Professor<br></br>Humanities and
																	Social Science Department<br></br> IIT Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
															</p>
											...
											<div className="row">
												<div className="col-md-5 py-2">
													<div className="card border-danger shadow">
														<div className="card-body">
															<h4 className="card-title text-danger">
																<strong></strong>Mr. Sandeep Pareek
															</h4>
															<p
																className="card-text text-dark mb-1"
																style={{ fontSize: `medium`, color: `#000` }}
															>
																<strong>
																	Assistant Registrar<br></br> IIT Dharwad
																</strong>
																<br></br>
																<span style={{ color: `#707070` }}></span>
															</p>
