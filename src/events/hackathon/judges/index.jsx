...
import Judge2 from '../../../images/events/devhack/vinit.jpg';
						...
						<div className="col-md-5 py-2">
							<div className="border-danger shadow">
								<div className="card-body">
									...
									>
										<strong>
											GDG Hubli Organiser Full Stack Engineer at Hashnode
										</strong>
										<span style={{ color: `#707070` }}></span>
									</p>
								</div>
						...
						<div className="col-md-5 py-2">
							<div className="border-danger shadow">
								<div className="card-body">
									...
									>
										<strong>
											Assistant Professor Biosciences and Bio engineering
						...
						<div className="col-md-5 py-2">
							<div className="border-danger shadow">
								<div className="card-body">
									...
									>
										<strong>
											Assistant Professor Electrical Engineering Department IIT
											Dharwad
										</strong>
										<span style={{ color: `#707070` }}></span>
									</p>
						...
						<div className="col-md-5 py-2">
							<div className="border-danger shadow">
								<div className="card-body">
									...
									>
										<strong>
											Assistant Professor Mathematics Department IIT Dharwad
										</strong>
										<span style={{ color: `#707070` }}></span>
									</p>
								</div>
						...
						<div className="col-md-5 py-2">
							<div className="border-danger shadow">
								<div className="card-body">
									...
									>
										<strong>
											Assistant Professor Mechanical Department IIT Dharwad
										</strong>
										<span style={{ color: `#707070` }}></span>
									</p>
								</div>
